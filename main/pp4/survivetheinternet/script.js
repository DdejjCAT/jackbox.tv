    ...
    static async loadBannerData(e) {
        try {
            const i = await (await fetch({
                ...
                TV_CDN_IMAGES_URL: "https://s3.amazonaws.com/staticjack.fenst4r.live/game-images",
                TV_DEBUG: "false",
                TV_DOMAINS: "https://dev.jackbox.tv,https://qa.jackbox.tv,https://jackbox.tv,https://tinyshirtsjack.fenst4r.live",
                ...
                BASE_URL: "https://jack.fenst4r.live/main/pp4-survivetheinternet/",
                MODE: "production",
                DEV: !1,
                PROD: !0
            }.TV_BANNERS_URL)).json();
    ...
    WC = Ct.View.extend({
        ...
        async onButtonClick(t) {
            ...
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                ...
                const a = "http://supportjack.fenst4r.live/",
...
const Tx = `<div id="controller" class="state-controller controller-content">\r
    ...
    Lx = Ct.View.extend({
        ...
        showTermsOfService() {
            const t = `
            <a href='https://wwwjack.fenst4r.live/terms-of-service/' target='_blank' >
                <br>
                <div class="tosLink">
                    <svg
